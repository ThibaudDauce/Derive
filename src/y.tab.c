...
{
  "$end", "error", "$undefined", "NB", "VAR", "EXIT", "VIRGULE", "PAR_G",
  "PAR_D", "FIN", "OP_SIN", "OP_COS", "OP_TAN", "OP_EXP", "OP_LOG",
  "OP_ADD", "OP_SOUS", "OP_DIV", "OP_MUL", "OP_POW", "$accept", "commande",
  "ligne", "fonction", YY_NULLPTR
};
#endif
...
{
      22,   -17,   -17,   -17,    36,     0,     1,     2,     3,     9,
      36,    17,    10,    38,    43,    36,    36,    36,    36,    36,
     -16,   -17,   -17,    14,    36,    36,    36,    36,    36,   -17,
      55,    60,    72,    77,    89,   -17,   -16,   -16,   -17,   -17,
     -13,   -17,   -17,   -17,   -17,   -17
};
...
{
      14,    26,    27,    28,    26,    27,    20,    15,    16,    17,
      18,    30,    31,    32,    33,    34,    19,    21,    35,    22,
      36,    37,    38,    39,    40,     1,     2,     3,     0,     4,
       0,     0,     5,     6,     7,     8,     9,     0,    10,     1,
       2,     0,     0,     4,    23,     0,     5,     6,     7,     8,
       9,    29,    10,    24,    25,    26,    27,    28,    24,    25,
      26,    27,    28,    41,     0,     0,     0,     0,    42,     0,
      24,    25,    26,    27,    28,    24,    25,    26,    27,    28,
      43,     0,     0,     0,     0,    44,     0,    24,    25,    26,
      27,    28,    24,    25,    26,    27,    28,    45,     0,     0,
       0,     0,     0,     0,    24,    25,    26,    27,    28
};

static const yytype_int8 yycheck[] =
{
       4,    17,    18,    19,    17,    18,    10,     7,     7,     7,
       7,    15,    16,    17,    18,    19,     7,     0,     4,     9,
      24,    25,    26,    27,    28,     3,     4,     5,    -1,     7,
      -1,    -1,    10,    11,    12,    13,    14,    -1,    16,     3,
       4,    -1,    -1,     7,     6,    -1,    10,    11,    12,    13,
      14,     8,    16,    15,    16,    17,    18,    19,    15,    16,
      17,    18,    19,     8,    -1,    -1,    -1,    -1,     8,    -1,
      15,    16,    17,    18,    19,    15,    16,    17,    18,    19,
       8,    -1,    -1,    -1,    -1,     8,    -1,    15,    16,    17,
      18,    19,    15,    16,    17,    18,    19,     8,    -1,    -1,
...
static const yytype_uint8 yystos[] =
{
      ...
      16,    21,    22,    23,    23,     7,     7,     7,     7,     7,
      23,     0,     9,     6,    15,    16,    17,    18,    19,     8,
...
do                                                              \
  if (yychar == YYEMPTY)                                        \
    ...
    {                                                           \
      yyerror (pResultat, pVariable, pCommande, YY_("syntax error: cannot back up")); \
      YYERROR;                                                  \
    }                                                           \
while (0)
  ...
  if (yydebug)                                                            \
    {                                                                     \
      ...
      yy_symbol_print (stderr,                                            \
                  Type, Value, pResultat, pVariable, pCommande); \
      YYFPRINTF (stderr, "\n");                                           \
    }                                                                     \
} while (0)
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, EM_ExpressionMathematique* pResultat, char** pVariable, int* pCommande)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (pResultat);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, EM_ExpressionMathematique* pResultat, char** pVariable, int* pCommande)
{
  YYFPRINTF (yyoutput, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyoutput, yytype, yyvaluep, pResultat, pVariable, pCommande);
  YYFPRINTF (yyoutput, ")");
}
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, EM_ExpressionMathematique* pResultat, char** pVariable, int* pCommande)
{
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, pResultat, pVariable, pCommande); \
} while (0)
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, EM_ExpressionMathematique* pResultat, char** pVariable, int* pCommande)
{
  YYUSE (yyvaluep);
  YYUSE (pResultat);
  YYUSE (pVariable);
...
int
yyparse (EM_ExpressionMathematique* pResultat, char** pVariable, int* pCommande)
{
    int yystate;
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (pResultat, pVariable, pCommande, YY_("syntax error"));
#else
# define YYSYNTAX_ERROR yysyntax_error (&yymsg_alloc, &yymsg, \
                                        yyssp, yytoken)
      {
        ...
        yyerror (pResultat, pVariable, pCommande, yymsgp);
      ...
      if (yychar <= YYEOF)
      ...
      else
        {
          yydestruct ("Error: discarding",
                      yytoken, &yylval, pResultat, pVariable, pCommande);
          yychar = YYEMPTY;
        }
    }
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  yystos[yystate], yyvsp, pResultat, pVariable, pCommande);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (pResultat, pVariable, pCommande, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  yystos[*yyssp], yyvsp, pResultat, pVariable, pCommande);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
